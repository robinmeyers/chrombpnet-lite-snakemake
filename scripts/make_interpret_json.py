...
parameters['ohe_filename'] = "outs/{sample}/fold{fold}/{sample}.fold{fold}.profile.ohe.npz".format(sample = snakemake.wildcards.sample, fold = snakemake.wildcards.fold)
parameters['attr_filename'] = "outs/{sample}/fold{fold}/{sample}.fold{fold}.profile.attr.npz".format(sample = snakemake.wildcards.sample, fold = snakemake.wildcards.fold)
